module BasicRequirements where
...
add_sensors :: SensorType -> ShipBuilder ()
add_sensors se = do
...
designAlpha = do
    start_blueprint "Programming Language Design Station"
    set_frame
    ...
    add_sensors Enhanced       -- 1 slot (Enhanced Sensor)               
                              -- Total: 10/10
    finalize_blueprint 
    
    
--     -- actually, we are not able to add more components after this, because this function has "return s"
